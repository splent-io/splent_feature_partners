"""
End-to-end tests for splent_feature_partners.
...
Run with:  splent feature:test splent_feature_partners --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_partners")
    assert "splent_feature_partners" in browser.page_source.lower()
